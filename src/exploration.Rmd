...
lm1 <- lm(loansData$Interest.Rate ~ loansData$FICO.Median + as.factor(loansData$Loan.Length.Months))
par(mfrow = c(1, 3))
palette(rev(colorRampPalette(brewer.pal(9,"Blues"))(40)))
plot(loansData$Interest.Rate, lm1$residuals, pch = 19, col = as.factor(loansData$FICO.Range))
palette(c(brewer.pal(5,"PRGn")[1],brewer.pal(5,"PRGn")[5]))
plot(loansData$Interest.Rate, lm1$residuals, pch = 19, col = as.factor(loansData$Loan.Length.Months))
```
...
m2LoansData <- loansData[!is.na(loansData$Amount.Funded.By.Investors),]
lm2 <- lm(m2LoansData$Interest.Rate ~ m2LoansData$FICO.Median + as.factor(m2LoansData$Loan.Length.Months) + m2LoansData$Amount.Funded.Range)
par(mfrow = c(1, 3))
palette(rev(colorRampPalette(brewer.pal(9,"Blues"))(40)))
plot(m2LoansData$Interest.Rate, lm2$residuals, pch = 19, col = m2LoansData$FICO.Median)
palette(c(brewer.pal(5,"PRGn")[1],brewer.pal(5,"PRGn")[5]))
plot(m2LoansData$Interest.Rate, lm2$residuals, pch = 19, col = as.factor(m2LoansData$Loan.Length.Months))
palette(c(brewer.pal(9,"Reds")[3],brewer.pal(9,"Reds")[6],brewer.pal(9,"Reds")[9]))
plot(m2LoansData$Interest.Rate, lm2$residuals, pch = 19, col = m2LoansData$Amount.Funded.Range)
```
